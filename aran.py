...
def download_files(msg):
    ...
    catCount = detectCat(fileName)
    if faceCount > 0 :
        print '[Picture] --->', fileName, 'Detect ' + str(faceCount) + 'face(s)'
        chatcore.send_image('C:/Users/Administrator/Desktop/wechatrobot-master/assets/face.jpg', msg['FromUserName'])
        result = u'发现了' + str(faceCount) + u'张美丽帅气的脸蛋儿。\n （づ￣3￣）づ╭❤～……' ## Reply to sender


    elif catCount > 0 :
        print '[Picture] --->', fileName, 'Detect ' + str(catCount) + 'face(s)'
        chatcore.send_image('C:/Users/Administrator/Desktop/wechatrobot-master/assets/cat.jpg', msg['FromUserName'])
        result = u'发现了' + str(catCount) + u'只可爱的喵咪。\n （づ￣3￣）づ╭❤～……'  ## Reply to sender
...
def download_files(msg):
    ...
    if faceCount > 0 :
        print '[Picture] --->', fileName, 'Detect ' + str(faceCount) + 'face(s)'
        chatcore.send_image('C:/Users/Administrator/Desktop/wechatrobot-master/assets/face.jpg', msg['FromUserName'])
        result = u'发现了' + str(faceCount) + u'个美丽帅气的脸蛋儿。\n （づ￣3￣）づ╭❤～……' ## Reply to sender
